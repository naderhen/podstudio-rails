...
class PodcastsControllerTest < ActionController::TestCase
  ...
  test "should create podcast" do
    assert_difference('Podcast.count') do
      post :create, podcast: { description: @podcast.description, name: @podcast.name, user_id: @podcast.user_id }
    end
  ...
  test "should update podcast" do
    patch :update, id: @podcast, podcast: { description: @podcast.description, name: @podcast.name, user_id: @podcast.user_id }
    assert_redirected_to podcast_path(assigns(:podcast))
  end
